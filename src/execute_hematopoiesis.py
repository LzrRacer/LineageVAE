...
average_inf_adata, average_tf_expression_df, average_tg_matrix, regulation_matrix = process_for_tf_analysis(adata_6, LineageVAE_exp, inf_adata.var_names, tf_target, trans, sample_num=100)
